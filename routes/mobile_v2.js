...
router.get('/marketApplist/admin/:spaceType', [mobileValidators.adminSMAppList_V2, errorMsgs], mobileController.adminSMAppList_V2);

router.get('/marketApplist/:linkCode/:spaceType', [mobileValidators.SMAppList_V2, errorMsgs], mobileController.SMAppList_V2);

router.post('/market-app-list', [mobileValidators.SMAppListV3, errorMsgs], mobileController.SMAppListV3);
