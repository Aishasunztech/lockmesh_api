 ...
 */
router.post('/login', [commonValidators.login, errorMsgs], authController.login);
 ...
 * @returns {Error}  default - Unexpected error
 */
router.post('/verify_code', [authValidators.verifyCode, errorMsgs], authController.verifyCode);
