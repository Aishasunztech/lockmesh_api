...
//                 return res.json({
//                     success: false,
//                     msg: await helpers.convertToLang(req.translation[MsgConstants.FAILED_AUTH_TOKEN], MsgConstants.FAILED_AUTH_TOKEN), // Failed to authenticate token.
//                 });
//             } else {
...
//                 //     return res.json({
//                 //         success: false,
//                 //         msg: await helpers.convertToLang(req.translation[MsgConstants.DEALER_ACTIV_SUCC], MsgConstants.DEALER_ACTIV_SUCC), // 'Failed to authenticate token.'
//                 //     });
//                 // }
//                 // } else {
//                 //     ath.status = false;
...
//         var data = {
//             success: false,
//             msg: await helpers.convertToLang(req.translation[MsgConstants.NO_TOKEN_PROVIDE], MsgConstants.NO_TOKEN_PROVIDE), // No token provided.'
//         }
