...
module.exports = {
    ...
    // updateAppSettings: async function (appId, guest, encrypted, enable) {

    //     console.log("updating into user_apps");

    //     var updateQuery = "update user_apps set guest=" + guest + " , encrypted=" + encrypted + " , enable=" + enable + " where app_id=" + appId + "";
    //     await sql.query(updateQuery, async function (error, row) {
    //         console.log("app updated:");
    //         console.log(updateQuery);
    //         console.log(row);
    //         if (row.affectedRows == 0) {
    //             console.log("app_setting_not_updated");
    //         } else {
    //             console.log("app_setting_updated");
    //         }
    //     });
